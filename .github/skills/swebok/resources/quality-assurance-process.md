# Software Quality Assurance Process: SQA, V&V, Reviews, and Audits
...
1. **Dynamic Analysis**: Involves executing or simulating the software code to look for errors and defects. Dynamic techniques include functional testing, performance testing, simulation, model checking, and black box testing.
1. **Formal Analysis**: Employs mathematical logic and formal specification languages to verify the correctness of crucial components, such as safety-critical algorithms or security protocols.
