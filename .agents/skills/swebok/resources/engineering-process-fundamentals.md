...
1. **Activity**: A set of cohesive tasks of a process. Activities group related tasks that contribute to a major milestone. For example, in the testing process, activities include test planning, test case design, and test execution.
1. **Task**: A required, recommended, or permissible action intended to contribute to the achievement of process outcomes. Tasks represent the smallest atomic units of work, defining who performs the action, the required resources, and the specific steps.
