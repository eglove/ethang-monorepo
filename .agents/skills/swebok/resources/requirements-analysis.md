...
1. Fail Point: The performance level below which the system's utility drops to zero. Below this point, the software cannot be placed in service.
...
1. **Product Family Development**: Separating requirements into:
