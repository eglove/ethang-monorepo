---
description: Automates the Release process for completed feature work by checking branch safety, staging changes, analyzing diffs, committing with conventional/actor-action messages, pushing to origin, and creating a pull request.
name: sdlc-5
---

# Standalone SDLC Phase 5 (sdlc-5) - Release & Pull Request Automation
