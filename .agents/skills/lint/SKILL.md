---
description: ALWAYS invoke this skill for any linting tasks. Do not run eslint directly. Specifically designed to understand and fix issues with @ethang/eslint-config. Aware of rules, tracks fix attempts, asks for help after 3 failures, and records difficult solutions to a static knowledge base.
name: lint
---
...
1. **Knowledge Base**: Check your static knowledge base for difficult rules before attempting to fix them.
...
1. **Knowledge Recording**: If you encounter a difficult to fix rule and successfully find a solution (or the user provides one), you MUST append the solution to your knowledge base.
