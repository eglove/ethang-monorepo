---
description: "End-to-end enterprise SDLC pipeline (SWEBOK v4 / ISO 12207): Concept → Maintenance Triage (defects) → Requirements → Architecture+STRIDE Threat Model → TDD Red/Green. Use for all production feature and maintenance work."
name: tdd
---
