...
| Ch 03 | Software Design | `resources/ch03-design.md` | SOLID, design-pattern, cohesion, DDD, encapsulation, SoC, ADR, refactor | ddd-strategic, ddd-tactical |
| Ch 04 | Software Construction | `resources/ch04-construction.md` | TDD, assertion, exception-handling, API, dependency, CI, cyclomatic-complexity, defensive-programming | tdd-principles, tdd-test-as-documentation |
| Ch 05 | Software Testing | `resources/ch05-testing.md` | test, coverage, mock, regression, mutation, equivalence-partitioning, boundary-value, shift-left | tdd-principles, tdd-state-coverage |
...
| Ch 11 | Software Engineering Models and Methods | `resources/ch11-models.md` | model, precondition, postcondition, invariant, state-machine, UML, traceability, formal-method | tdd-state-coverage |
| Ch 12 | Software Quality | `resources/ch12-quality.md` | quality, defect, V&V, SQA, ISO-25010, CoSQ, RCA, peer-review, integrity-level, audit | rca-five-whys |
...
| Ch 17 | Mathematical Foundations | `resources/ch17-math.md` | FSM, logic, floating-point, set-theory, graph, grammar, probability, overflow | tdd-state-coverage |
| Ch 18 | Engineering Foundations | `resources/ch18-engineering.md` | RCA, 5-whys, fishbone, measurement, GQM, statistics, wicked-problem, FTA | rca-five-whys |
