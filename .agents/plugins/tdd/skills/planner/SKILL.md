---
name: planner
description: "Adopt this role when the tdd-pipeline directs you to plan: produces the state machine, completeness check, unit + integration Vitest test inventories, and a minimal implementation plan. Use during the planning step of the TDD pipeline."
---
