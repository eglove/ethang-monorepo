...
description: Invoke during security code review. Covers React XSS/token storage/CSP checks, Hono/Cloudflare Worker input validation/auth scope/CORS checks, Drizzle SQL injection prevention, OWASP Top 10 stack-specific check columns, and PII/privacy data minimization controls. Generic OWASP descriptions and CERT Top 10 live in SWEBOK Ch 13.
---
