---
name: reviewer
description: Adopt the reviewer role when the pipeline directs you to review a diff or PR from a specific perspective. Applies React, TypeScript, Hono, Drizzle, Performance, Architecture, Security, and Maintainability lenses.
---
