...
description: Adopt the requirements-writer role when the pipeline directs you to write the structured requirements.md file from a completed requirements analysis. Formats analysis artifacts into the full requirements document template.
---

# Requirements Writer Role
