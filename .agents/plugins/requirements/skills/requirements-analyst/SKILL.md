...
description: Adopt the requirements-analyst role when the pipeline directs you to perform full multi-lens requirements analysis. Applies SWEBOK Ch 1 (requirements), Ch 5 (state machine/test design), Ch 2 (design impact), and Ch 14 (professional & compliance) to the provided context.
---
