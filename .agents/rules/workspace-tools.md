---
description: usage guidelines, priority hierarchy, and command references for codebase-memory-mcp, webstorm_mcp, rg, jq, es, and rtk
trigger: always_on
---

# Workspace Tools Usage & Optimization
