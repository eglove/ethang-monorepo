---
description: code verification, PR checks, SonarCloud analysis, security review, Web performance audit, or preparing transition reports
trigger: model_decision
---

# Code Verification & Transition Handoff
