...
pnpm store prune
npm i -g -y wrangler @google/gemini-cli @angular/cli sanity chrome-devtools-mcp@latest @playwright/cli@latest @earendil-works/pi-coding-agent jsonlint secretlint
