...
const GENERATED_FILE_BANNER = `// GENERATED FILE — DO NOT EDIT DIRECTLY
// Generated by src/build/update-rules.ts from the plugin definitions in src/setup/.
// Regenerate with: pnpm --filter @ethang/eslint-config build
`;

export const createConfigFile = async (output: OutputConfig) => {
  const importList = buildImportList(output);

  let configFile = `${GENERATED_FILE_BANNER}// @ts-nocheck\n`;
