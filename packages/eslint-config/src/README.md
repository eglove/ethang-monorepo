...
- 45 rules from [@html-eslint/eslint-plugin](https://github.com/html-eslint/html-eslint)
...
- 17 rules from [@eslint/markdown](https://github.com/eslint/markdown)
- 8 rules from [@eslint/css](https://github.com/eslint/css)
