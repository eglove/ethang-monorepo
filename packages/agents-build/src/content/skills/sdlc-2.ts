...
export const sdlc2 = defineSkill({
  content: `# Standalone SDLC Phase 2 (sdlc-2) - Architecture & Design Director
...
`,
  description:
    "Interactive architecture and design interview to translate requirements into SARA-compliant design documents with Mermaid diagrams.",
  name: "sdlc-2"
});
