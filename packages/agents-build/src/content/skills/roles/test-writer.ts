...
\`\`\``,
  description:
    "Adopt this role when the tdd-pipeline directs you to write RED tests: produces failing Vitest unit and integration tests (React + TanStack, Hono + Drizzle) that fail for the right reason. Use during the RED step of the TDD pipeline.",
  name: "test-writer"
});
