...
export const qualityAnalystRole = defineSkill({
  content: `# Role: Quality Analyst
...
`,
  description:
    "Quality Analyst role: measures software quality during Stage 5 (Verification & Validation) using SonarCloud quality gate, test coverage verification, Web Performance audits (frontend), and validation traceability against approved requirements. The SonarCloud quality gate is a hard gate blocking Stage 6.",
