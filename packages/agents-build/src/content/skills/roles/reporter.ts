...
export const reporterRole = defineSkill({
...
\`\`\``,
  description:
    "Adopt the reporter role when the pipeline directs you to produce a structured written artifact: review report, TDD summary, or requirements summary. Outputs GitHub-flavored markdown.",
  name: "reporter"
});
