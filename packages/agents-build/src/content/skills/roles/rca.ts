...
export const rcaSkill = defineSkill({
...
\`\`\``,
  description:
    "Adopt this role when the tdd-pipeline directs you to analyze a bug: separates problem from proposed solution, runs the 5-Whys, scans the repo for the defect pattern, checks git history for regressions, and produces RCA_FINDINGS. Use during the optional RCA step for bug-shaped tasks.",
  name: "rca"
});
