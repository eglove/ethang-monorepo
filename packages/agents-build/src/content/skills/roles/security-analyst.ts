...
export const securityAnalystRole = defineSkill({
  content: `# Role: Security Analyst
...
`,
  description:
    "Security Analyst role: performs STRIDE threat modeling during Stage 3 (Architecture) and OWASP Top 10 code review during Stage 5 (Verification). Invoked in parallel with the planner in Stage 3, and in parallel with the quality-analyst in Stage 5.",
