...
export const webstormSkill = defineSkill({
  content: `# JetBrains WebStorm MCP Server Reference

Use this skill to interact with the JetBrains WebStorm IDE via the Model Context Protocol (MCP) server. These tools allow search, file manipulation, refactoring, building, and running tests directly inside the IDE.
...
`,
  description:
    "Exposes documentation and usage guidelines for WebStorm's integrated Model Context Protocol (MCP) server tools.",
  name: "webstorm-mcp"
});
