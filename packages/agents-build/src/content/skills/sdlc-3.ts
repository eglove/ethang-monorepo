...
export const sdlc3 = defineSkill({
  content: `# Standalone SDLC Phase 3 (sdlc-3) - Guided Implementation & Verification
...
`,
  description:
    "Guided implementation and development skill enforcing strict TDD, coding standards, and ESLint auto-fix loop guards.",
  name: "sdlc-3"
});
