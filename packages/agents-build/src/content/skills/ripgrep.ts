...
export const ripgrep = defineSkill({
  content: [
    ...
    {
      code: 'rtk rg -i "my-search-term" packages/agents-build/src/',
      language: "bash",
      type: "codeBlock"
    },
    {
    ...
    {
      code: 'rtk rg -w "functionName" src/',
      language: "bash",
      type: "codeBlock"
    },
    {
    ...
    {
      code: 'rtk rg -A 3 "class User" packages/',
      language: "bash",
      type: "codeBlock"
    },
    {
    ...
    {
      code: 'rtk rg -B 2 "return true;" src/',
      language: "bash",
      type: "codeBlock"
    },
    {
    ...
    {
      code: 'rtk rg -C 3 "function complexLogic" src/',
      language: "bash",
      type: "codeBlock"
    },
    {
    ...
    {
      code: 'rtk rg -l "export const globalRules" packages/',
      language: "bash",
      type: "codeBlock"
    },
    {
    ...
    {
      code: 'rtk rg -t ts "interface" src/',
      language: "bash",
      type: "codeBlock"
    },
    {
    ...
    {
      code: 'rtk rg --hidden "secret" .github/',
      language: "bash",
      type: "codeBlock"
    },
    {
