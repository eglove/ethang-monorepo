...
`,
  description: "Explains how to use the jq JSON processor for slicing, filtering, mapping, and formatting JSON files, emphasizing token conservation via rtk.",
  name: "jq"
});
