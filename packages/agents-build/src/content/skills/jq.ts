...
export const jq = defineSkill({
  content: [
    ...
    {
      code: 'jq ".dependencies" package.json',
      language: "bash",
      type: "codeBlock"
    },
    {
    ...
    {
      code: 'jq ".scripts.build" package.json',
      language: "bash",
      type: "codeBlock"
    },
    {
    ...
    {
      code: 'jq "[ .[] | { name: .name, version: .version } ]" packages.json',
      language: "bash",
      type: "codeBlock"
    },
    {
    ...
    {
      code: String.raw`jq ".[] | select(.tags[] | contains(\\"frontend\\"))" data.json`,
      language: "bash",
      type: "codeBlock"
    },
    {
