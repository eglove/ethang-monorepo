...
export const sdlc6 = defineSkill({
  content: `# Standalone SDLC Phase 6 (sdlc-6) - Maintenance & Troubleshooting Automation
...
`,
  description:
    "Automates the Phase 6 Maintenance and Troubleshooting workflow by parsing CI/SonarQube reports, running dependency impact scans, applying automated correctives, and verifying changes locally.",
  name: "sdlc-6"
});
