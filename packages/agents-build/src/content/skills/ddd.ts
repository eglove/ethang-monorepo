...
export const ddd = defineSkill({
  content: `# Domain-Driven Design (DDD) Guideline Finder

This skill acts as a comprehensive reference guide to Domain-Driven Design (DDD) and Clean/Modular Architecture. It provides a structured taxonomy of strategic design, tactical patterns, clean layering, CQRS, and specifications to align software construction with business domains.
