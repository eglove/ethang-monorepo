...
export const tddTestAsDocumentationSkill = defineSkill({
  content: `# Tests as Executable Documentation
...
6. If the feature has distinct states (loading, loaded, error, empty, etc.), do describe blocks mirror
  ...
  description:
    "Covers behavior-description test naming, state-machine describe block structure, specific contract assertions, mock setup as dependency documentation, and a completeness self-check. Use when writing or reviewing any test file.",
  name: "tdd-test-as-documentation"
});
