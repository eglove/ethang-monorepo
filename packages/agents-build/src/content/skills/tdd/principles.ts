...
export const tddPrinciplesSkill = defineSkill({
  content: `# TDD Principles
...
- **If the proposed fix is wrong**, document why and propose the correct fix. Do not silently
  ...
  description:
    "Covers Red-Green-Refactor scientific method, Vitest it.each parameterized test syntax, and trust-the-problem hypothesis discipline. Use before writing any tests; defer test-design theory and GREEN construction rules to the swebok skill (Ch 5, Ch 4).",
  name: "tdd-principles"
});
