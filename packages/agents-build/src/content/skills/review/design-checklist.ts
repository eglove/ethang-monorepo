...
export const reviewDesignChecklist = defineSkill({
  content: `# Design and Quality Review Checklist
...
- [ ] Naming tense is consistent within a bounded context — note inconsistencies but do not require immediate refactor of existing names`,
  description:
    "Invoke during code review. Covers React component design (prop drilling, effect discipline, state co-location), Hono/Cloudflare Worker route design (thin handlers, middleware layering), Drizzle query patterns, architecture layer violations and coupling/cohesion checks, common anti-patterns, and DDD tactical patterns (CQRS, Specification, Value Objects, Domain Events). Theory (SOLID, DbC, coupling/cohesion levels, complexity thresholds) lives in SWEBOK Ch 3/2/16/12.",
  name: "review-design-checklist"
});
