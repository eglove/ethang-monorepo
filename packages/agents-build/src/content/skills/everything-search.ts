...
export const everythingSearch = defineSkill({
  content: [
    ...
    {
      code: String.raw`rtk es -r "^test_.*\\.ts$"`,
      language: "bash",
      type: "codeBlock"
    },
    {
    ...
    {
      code: String.raw`rtk es -p "packages\\agents-build\\*.ts"`,
      language: "bash",
      type: "codeBlock"
    },
    {
