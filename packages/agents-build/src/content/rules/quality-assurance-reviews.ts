...
export const qualityAssuranceReviews = defineRule({
  content: `# Quality Assurance Reviews
...
- [ ] **Metrics Tracked**: Were the review effort, defect count, and code size logged for process calibration?`,
  description:
    "quality assurance reviews, peer code reviews, inspections, and checklists",
  filename: "quality-assurance-reviews",
