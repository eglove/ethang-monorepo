...
export const informationHiding = defineRule({
  content: `# Information Hiding
...
- [ ] **Adapter Pattern Verification**: Has the adapter pattern been verified by writing mock unit tests for wrapped third-party packages?`,
  description:
    "information hiding, encapsulation, public interfaces, and API design",
  filename: "information-hiding",
