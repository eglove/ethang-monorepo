...
export const reviewSecurityChecklist = defineRule({
...
- [ ] If yes: PII not logged, not cached in browser beyond session, not exposed in URLs or query strings`,
  description:
    "reviewing code for security vulnerabilities, XSS, injection, token storage, or privacy and PII compliance",
  filename: "review-security-checklist",
