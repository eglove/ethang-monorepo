...
export const engineeringProcessLifecycles = defineRule({
  content: `# Software Engineering Process Life Cycles
...
2. **Technical Management Processes**: Planning, control, and governance mechanisms. They cover project planning, assessment and control, decision management, risk management, configuration management, information management, measurement, and quality assurance.
3. **Organizational Project-Enabling Processes**: Establish infrastructure and resource capabilities, managing the life cycle model, infrastructure, portfolio, human resources, quality, and organizational knowledge.
4. **Agreement Processes**: Define contractual and relational boundaries, covering acquisition and supply.
...
2. **Development**: Refining requirements, designing architecture, implementing code, and conducting verification and validation.
3. **Production**: Replicating, manufacturing, and testing the software product.
4. **Utilization**: Operating the system in its target environment to deliver value to users.
5. **Support**: Providing ongoing maintenance, operational assistance, and corrective updates.
6. **Retirement**: Decommissioning, transitioning, and systematically disposing of the system.
...
2. **Technical Management Level**: Covers project planning, assessment, control, and tracking of individual engineering projects.
3. **Organizational/Executive Level**: Focuses on organizational project-enabling processes, portfolio management, infrastructure, and life cycle model management.
