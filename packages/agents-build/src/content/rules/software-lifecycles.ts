...
export const softwareLifecycles = defineRule({
  content: `# Software Lifecycles
...
- [ ] **Hybrid Boundaries Defined**: Were V-Model versus Agile boundaries clearly identified in multi-tier changes?`,
  description:
    "software lifecycles, development models, agile iterations, and phase entry/exit criteria",
  filename: "software-lifecycles",
