...
export const engineeringProcessAssessmentImprovement = defineRule({
  content: `# Software Process Assessment and Improvement
...
2. **Set Goals**: Define clear, measurable goals for project success and process performance.
3. **Choose Process**: Select appropriate software engineering processes, methods, and tools based on goals.
4. **Execute**: Implement the chosen processes, construct software work products, and collect project data.
5. **Analyze**: Evaluate collected data to analyze current practices and assess the impact of process changes.
6. **Package**: Document lessons learned, update process models, and store historical data in an experience factory for future projects.
