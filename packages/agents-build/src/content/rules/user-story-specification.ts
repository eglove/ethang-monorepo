...
export const userStorySpecification = defineRule({
  content: `# User Story Specification
...
- [ ] **No Forbidden Terminology**: Has the story text been verified to contain no restricted words?`,
  description:
    "user stories, BDD, Given-When-Then, and functional specifications",
  filename: "user-story-specification",
