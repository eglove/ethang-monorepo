...
export const executionPlanning = defineRule({
  content: `# Execution Planning & Architecture
...
\`\`\``,
  description:
    "architecture design, execution planning, detailed design, threat modeling, or creating execution-plan.md",
  filename: "execution-planning",
