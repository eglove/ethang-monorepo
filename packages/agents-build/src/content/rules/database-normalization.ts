...
export const databaseNormalization = defineRule({
...
- [ ] **Unique Constraints Configured**: Are business-level uniqueness rules enforced using unique constraints at the database level?`,
  description:
    "database normalization, relational schema design, 3NF, constraints, and indexes",
  filename: "database-normalization",
