...
export const architecturalDocumentation = defineRule({
  content: `# Architectural Documentation
...
- [ ] **Integration Interfaces**: Are the APIs and event structures connecting Bounded Contexts fully specified?`,
  description:
    "architectural description, viewpoints, notations, and documentation clarity",
  filename: "architectural-documentation",
