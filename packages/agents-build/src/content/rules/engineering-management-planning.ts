...
export const engineeringManagementPlanning = defineRule({
  content: [
    {
      level: 1,
      text: "Engineering Management Planning",
      type: "header"
    },
    {
      level: 2,
    ...
    },
    {
      items: [
        {
          text: "Has a formal Software Development Lifecycle (SDLC) model been selected and tailored based on the project scope, software requirements, and a risk assessment?"
        },
        {
          text: "Were the positions of the software project lifecycle on the predictive-to-adaptive continuum explicitly defined, including requirements handling and stakeholder involvement?"
        },
        {
          text: "Were application domain characteristics, technical complexity, and software quality requirements formally evaluated when tailoring the lifecycle model?"
        },
        {
          text: "Is there an initial risk assessment that documents and gains stakeholder acceptance of the project's risk profile?"
        },
        {
          text: "Has a software quality management plan been established that defines procedures and responsibilities for software quality assurance (SQA), verification and validation (V&V), technical reviews, and audits?"
        },
        {
          text: "Are there defined processes and responsibilities for the ongoing review and revision of the project plan throughout its lifecycle?"
        },
        {
          text: "Were multiple estimation approaches used to estimate effort, schedule, and cost, and were their differences reconciled?"
        },
        {
          text: "Does the cost estimation account for human elements, including individual capability, team dynamics, and culture of the development environment?"
        },
        {
          text: "Was a calibrated estimation model based on historical size and effort data utilized and reconciled with bottom-up estimation?"
        },
        {
          text: "Are task dependencies identified and documented using a visualization tool (e.g., a Gantt chart) showing concurrent and sequential paths?"
        },
        {
          text: "Has a RACI matrix (Responsible, Accountable, Consulted, Informed) been established to assign tasks and deliverables?"
        },
        {
          text: "Is there a continuous risk management process that identifies, analyzes, prioritizes, and develops mitigation plans for risks?"
        },
        {
          text: "Is a formal risk register maintained to track risk factors, probabilities, impacts, exposures, and compliance data?"
        },
        {
          text: "Have explicit project abandonment conditions been negotiated and agreed upon by all relevant stakeholders?"
        },
        {
          text: "Are software-unique risk factors, such as the tendency of engineers to add unneeded features or the intangible nature of software, accounted for?"
        },
        {
          text: "Are software quality requirements, specifically safety and security (cybersecurity), prioritized in the risk management plan?"
        },
        {
          text: "Does the quality plan align with the ISO/IEC 25000 series of standards and ISO/IEC/IEEE 15939 measurement frameworks?"
        },
        {
          text: "Are plans and processes for supporting activities (e.g., software configuration management, documentation, problem resolution) managed?"
        },
        {
          text: "Does the project monitoring and reporting mechanism match the chosen SDLC and actual constraints of the project?"
        },
        {
          text: "In adaptive lifecycles, is requirements traceability implemented to monitor coordination and control as emerging plans evolve?"
        }
      ],
      type: "numberedList"
    }
