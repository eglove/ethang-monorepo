...
export const architecturalTactics = defineRule({
  content: `# Architectural Tactics
...
- [ ] **Explicit Member Access**: Are all methods and properties on synthesized tactic classes declared with explicit accessibility modifiers?`,
  description:
    "architectural tactics, availability, performance, and security gates",
  filename: "architectural-tactics",
