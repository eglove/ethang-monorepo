...
export const testCompletionCriteria = defineRule({
  content: `# Test Completion Criteria
...
- [ ] **Task List Sync**: Are all verification, coverage, and mutation tasks recorded and checked off in \`task.md\`?`,
  description:
    "test completion criteria, test coverage targets, and objective verification",
  filename: "test-completion-criteria",
