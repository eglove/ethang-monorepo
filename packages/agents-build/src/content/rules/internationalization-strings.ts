...
export const internationalizationStrings = defineRule({
  content: `# Internationalization Strings
...
- [ ] **Explicit Accessibility**: Are all localization helper methods declared with explicit accessibility modifiers?`,
  description:
    "internationalization, locales, user-facing text, and string isolation",
  filename: "internationalization-strings",
