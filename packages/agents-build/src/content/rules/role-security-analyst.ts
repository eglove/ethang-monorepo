...
export const roleSecurityAnalyst = defineRule({
...
\`\`\``,
  description:
    "acting as a security-analyst subagent, performing STRIDE threat modeling, or reviewing code against OWASP Top 10",
  filename: "role-security-analyst",
