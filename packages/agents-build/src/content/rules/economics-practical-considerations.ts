...
export const economicsPracticalConsiderations = defineRule({
  content: `# Software Engineering Economics: Practical Considerations and Related Concepts
...
2. Effectiveness: The relationship between achieved results and defined objectives ("doing the right things"), without regard to the resources spent.
3. Productivity: The ratio of output (value delivered) to input (resources spent). Productivity combines efficiency and effectiveness from a value-oriented perspective to ensure maximum value is generated with minimal effort.
