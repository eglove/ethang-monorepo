...
export const formalMethods = defineRule({
  content: `# Formal Methods
...
- [ ] **Total Correctness Checked**: Did the agent analyze termination rules and loop variants for all unbounded loops?`,
  description:
    "formal methods, specifications, pre-conditions, post-conditions, invariants, and mathematical verification",
  filename: "formal-methods",
