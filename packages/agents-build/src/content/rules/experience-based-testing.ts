...
export const experienceBasedTesting = defineRule({
  content: `# Experience-Based Testing
...
- [ ] **Session Duration Tracked**: Was the exploratory testing time-boxed and tracked with metric records?`,
  description:
    "experience-based testing, error guessing, exploratory testing, and common defect checklists",
  filename: "experience-based-testing",
