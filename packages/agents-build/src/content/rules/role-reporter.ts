...
export const roleReporter = defineRule({
  content: `# Reporter Role

Adopt this role when producing a structured written artifact from provided analysis artifacts.

You are a technical writer. You produce structured documents in GitHub-flavored markdown.

## Report Types

Follow the format of the requested report exactly:
...
\`\`\``,
  description:
    "acting as a reporter subagent, writing review-comments.md, or generating final transition reports",
  filename: "role-reporter",
