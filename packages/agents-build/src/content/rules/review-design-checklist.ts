...
export const reviewDesignChecklist = defineRule({
...
- [ ] Naming tense is consistent within a bounded context — note inconsistencies but do not require immediate refactor of existing names`,
  description:
    "reviewing React component design, Hono/Cloudflare Worker routes, Drizzle database queries, or general architecture quality",
  filename: "review-design-checklist",
