...
export const securityByDesign = defineRule({
  content: `# Security & Privacy by Design
...
- [ ] **Content Security Policy Configured**: Are script sources explicitly restricted on the UI layer?`,
  description:
    "security by design, CIA triad, OWASP Top 10, and STRIDE threat modeling",
  filename: "security-by-design",
