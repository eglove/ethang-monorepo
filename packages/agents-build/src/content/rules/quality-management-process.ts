...
export const qualityManagementProcess = defineRule({
  content: `# Software Quality Management Process: QMS, Improvement, and Measurement
...
2. *Level 1 (Performed)*: The process achieves its process purpose.
3. *Level 2 (Managed)*: The process is planned, monitored, and adjusted, and its work products are established, controlled, and maintained.
4. *Level 3 (Established)*: A defined process is implemented based on a standardized organizational process.
5. *Level 4 (Predictable)*: The process operates quantitatively within defined limits to achieve its outcomes.
6. *Level 5 (Optimizing)*: The process is continuously improved to meet current and projected business goals.
