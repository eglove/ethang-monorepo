...
export const incidentVsProblemManagement = defineRule({
  content: `# Incident vs. Problem Management
...
- [ ] **Walkthrough Record Completed**: Does \`walkthrough.md\` document the final regression test outputs and resolution state?`,
  description:
    "incident management, problem management, 5-Whys root cause analysis, and systemic fixes",
  filename: "incident-vs-problem-management",
