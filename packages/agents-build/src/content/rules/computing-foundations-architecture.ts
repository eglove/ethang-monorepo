...
export const computingFoundationsArchitecture = defineRule({
  content: [
    {
      level: 1,
      text: "Computing Foundations - Computer Architecture and Organization",
      type: "header"
    },
    {
      level: 2,
    ...
    },
    {
      items: [
        {
          text: "**Architecture vs. Organization Distinction**: Has the system design clearly separated the architectural specifications (what the system does) from the organizational implementation details (how components are connected)?"
        },
        {
          text: "**Bus Selection and Timing Analysis**: Have the address, data, and control buses been selected and analyzed for timing, width, and throughput constraints?"
        },
        {
          text: "**Bus Topology Conformance**: Has the design chosen the correct bus topology (simplex, half-duplex, full-duplex, serial, parallel, Wishbone, or specialized industrial standards) for the target environment?"
        },
        {
          text: "**Memory Space Partitioning**: Has the system's memory model been evaluated to prevent Von Neumann bottlenecks or to enforce Harvard code/data separation constraints?"
        },
        {
          text: "**Code Space Protection**: In modified Harvard designs, are the code sections marked as read-only to prevent runtime instruction corruption?"
        },
        {
          text: "**ISA Model Selection**: Has the choice between RISC and CISC design philosophies been justified based on compile-time efficiency, execution speed, and instruction size constraints?"
        },
        {
          text: "**Concurrency Stream Classification**: Has the system's parallel processing model been classified according to Flynn's Taxonomy (SISD, SIMD, MISD, MIMD) to ensure compatibility with compiler and runtime capabilities?"
        },
        {
        ...
        {
          text: "**Memory Hierarchy Mapping**: Has the memory hierarchy (caches, SRAM, DRAM, DDR versions) been mapped to ensure latency-critical data resides in high-speed tiers?"
        },
        {
          text: "**I/O Mapping Paradigm**: Is the system's I/O access model (memory-mapped vs. I/O-mapped) documented and supported by the target operating system?"
        },
        {
          text: "**Device Driver Compatibility**: Have the device driver interfaces been verified against the target operating system's kernel model and security boundaries?"
        },
        {
          text: "**Control Unit Design Verification**: If designing embedded hardware, has the choice between hardwired and microprogrammable control units been justified for speed vs. flexibility?"
        },
        {
          text: "**Resource Contingency Planning**: Have hardware resource contingencies (memory capacity, bus bandwidth, processing overhead) been built into the system design limits?"
        },
        {
          text: "**SWEBOK Hardware Alignment**: Does the software engineering process align with the computer organization and architecture standards defined in SWEBOK v4?"
        }
      ],
      type: "unorderedList"
    }
