...
export const swebokCh03Design = defineRule({
  content: `# Software Design (SWEBOK v4, Chapter 3)
...
`,
  description:
    "Software Design: design principles, patterns, and domain-driven design",
  filename: "swebok-ch03-design",
