...
export const roleRequirementsAnalyst = defineRule({
  content: `# Requirements Analyst Role
...
\`\`\``,
  description:
    "acting as a requirements-analyst subagent, analyzing issues, or identifying stakeholder needs",
  filename: "role-requirements-analyst",
