...
export const computingFoundationsDataStructuresAlgorithms = defineRule({
  content: `# Computing Foundations - Data Structures and Algorithms
...
2. **Composite or Compound Data Types**: Formed by grouping multiple primitive or other composite types. These are subdivided into:
