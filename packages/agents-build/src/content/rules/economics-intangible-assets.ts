...
export const economicsIntangibleAssets = defineRule({
  content: `# Software Engineering Economics: Identifying and Characterizing Intangible Assets
...
2. Impact indicators: These assess how much the specific intangible asset contributes to the execution of business processes or the achievement of business goals.
