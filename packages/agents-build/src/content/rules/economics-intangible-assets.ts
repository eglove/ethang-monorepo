...
export const economicsIntangibleAssets = defineRule({
  content: [
    {
      level: 1,
      text: "Software Engineering Economics: Identifying and Characterizing Intangible Assets",
      type: "header"
    },
    {
      level: 2,
    ...
    {
      level: 3,
      text: "1.8 Quantitative Assessment: Quality Valuation (Qval)",
      type: "header"
    },
    {
    ...
    },
    {
      items: [
        {
          text: "Were the high-level business goals of the client organization clearly defined and documented before eliciting intangible assets?"
        },
        {
          text: "Has a deliberate survey of business processes been conducted if well-documented processes are not readily available?"
        },
        {
          text: "Are tacit and explicit knowledge assets of the client organization explicitly distinguished and identified during requirements elicitation?"
        },
        {
          text: "Have the specific intangible assets been mapped to the 11 Generic Intangible Assets (GIAs) to ensure comprehensive domain coverage?"
        },
        {
          text: "Was a qualitative relative importance score on a scale of 1 to 5 assigned to each identified specific intangible asset?"
        },
        {
          text: "Are the software products proposed for digital transformation explicitly mapped to the specific intangible assets they support?"
        },
        {
          text: "Were the quality and impact indicators for each intangible asset formally defined, standardized, and normalized?"
        },
        {
          text: "Is Qval calculated as the arithmetic mean of the normalized quality indicators to assess the asset's structural health?"
        },
        {
          text: "Is Ival calculated as the arithmetic mean of the normalized impact indicators to assess the asset's business value?"
        },
        {
          text: "Was the linear valuation KAval computed on a standardized scale of -1 to 1 to represent the general state of each asset?"
        },
        {
          text: "Are intangible assets with both quality and impact indicators classified into the correct Case 1 quadrants (Warning, Replaceable, Evolving, Stable)?"
        },
        {
          text: "Were explicit organizational quality and impact thresholds established for determining the acceptability of each asset?"
        },
        {
          text: "Has a value proposition map been generated with stakeholders to identify emerging needs and align software products with assets?"
        },
        {
          text: "Are the characterized intangible assets visually linked to the components of the client's business model?"
        },
        {
          text: 'Does the final software proposal document the risks of automating processes supported by assets in a "Warning" state?'
        },
        {
          text: "Was the decision to select specific software products treated as a multiple-attribute decision incorporating cost, time, complexity, and asset impact?"
        },
        {
          text: "Have all stakeholders reviewed the business model canvas enriched with the intangible asset status prior to project initiation?"
        }
      ],
      type: "unorderedList"
    }
  ...
  filename: "economics-intangible-assets",
