...
export const architecturalEvaluation = defineRule({
  content: `# Architectural Evaluation
...
- [ ] **Explicit Member Access**: Are all methods and properties on evaluation helper classes declared with explicit accessibility modifiers?`,
  description:
    "architectural evaluation, ATAM, design trade-offs, and quality attributes",
  filename: "architectural-evaluation",
