...
export const tddPrinciples = defineRule({
  content: `# TDD Principles & Test Conventions
...
- [ ] **Karl Popper Falsifiability**: Was the RED phase test failure verified to be due to assertion failure rather than a syntax or compile error?`,
  description:
    "Covers Red-Green-Refactor scientific method, Vitest it.each parameterized test syntax, unit and integration test conventions, RED/GREEN validation steps, and trust-the-problem hypothesis discipline. Use before writing any tests.",
  filename: "tdd-principles",
