...
export const requirementsChangeControl = defineRule({
  content: `# Requirements Change Control
...
- [ ] **Configuration Auditing**: Has the agent verified that the version tags or commits correspond exactly to the approved change requests?`,
  description:
    "requirements change control, change requests, and scope agreement",
  filename: "requirements-change-control",
