...
export const requirementsCompleteness = defineRule({
...
- [ ] **Forbidden Terms Scan**: Has the requirements specification been audited to ensure no restricted platform vocabulary is present?`,
  description:
    "requirements completeness, consistency, feasibility, and quality criteria",
  filename: "requirements-completeness",
