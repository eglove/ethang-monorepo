...
export const roleQualityAnalyst = defineRule({
...
\`\`\``,
  description:
    "acting as a quality-analyst subagent, measuring code quality, or verifying test coverage and SonarCloud status",
  filename: "role-quality-analyst",
