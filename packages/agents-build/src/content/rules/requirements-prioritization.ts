...
export const requirementsPrioritization = defineRule({
...
- [ ] **Out-of-Scope Enforcement**: Have all requirements marked "Won't Have" been explicitly barred from code implementation?`,
  description:
    "requirements prioritization scale, MoSCoW, numerical scale, and value-cost tradeoffs",
  filename: "requirements-prioritization",
