...
import { reviewSecurityChecklist } from "../skills/review/security-checklist.ts";
import { reporterRole } from "../skills/roles/reporter.ts";
import { reviewerRole } from "../skills/roles/reviewer.ts";
...
export const reviewPlugin = definePlugin({
  name: "review",
  rules: [reviewEdgeCases],
  skills: [
    reviewPipeline,
    reviewerRole,
    reporterRole,
