...
Maybe the debates deffered objections to later. There were errors or warnings in the logs, or given all context
a new feature or refactor would make sense. This is relatively free form exploration across the entire codebase.
Anything it comes up with can be appended to user_notes.
