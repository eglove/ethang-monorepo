...
export type AllArticlesQuery = { allArticles: { pageInfo: { hasNextPage: boolean, endCursor: string | null }, edges: Array<{ node: { id: string, isRead: boolean, title: string, link: string, publishedAt: string | null, feed: { id: string, title: string } } }> } };
...
export type FeedArticlesQuery = { feedArticles: { pageInfo: { hasNextPage: boolean, endCursor: string | null }, edges: Array<{ node: { id: string, isRead: boolean, title: string, link: string, publishedAt: string | null, feed: { id: string, title: string } } }> } };
