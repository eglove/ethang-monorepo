...
export type AllArticlesQuery = { subscriptions: { edges: Array<{ node: { id: string, title: string, articles: { edges: Array<{ node: { id: string, isRead: boolean, title: string, link: string, publishedAt: string | null } }> } } }> } };
