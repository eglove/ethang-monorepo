...
import { CalendarWeekViewHeading } from "./calendar-week-view-heading.tsx";
...
export const CalendarWeekView = ({
  ...
  return (
    <div className="isolate flex flex-auto flex-col bg-white">
      <CalendarWeekViewHeading />
      <ScrollArea className="flex-auto">
        <ScrollAreaViewport>
          <div className="flex max-w-full flex-none flex-col sm:max-w-none md:max-w-full w-[165%]">
