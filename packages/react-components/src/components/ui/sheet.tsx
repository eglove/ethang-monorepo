...
const SheetOverlay = ({
  className,
  ...properties
}: Readonly<ComponentProps<typeof Overlay>>) => {
  return (
    <Overlay
      className={
        cn(
...
type SheetContentProperties = ComponentProps<typeof Content>
...
const SheetTitle = ({
  className,
  ...properties
}: Readonly<ComponentProps<typeof Title>>) => {
  return (
    <Title
...
const SheetDescription = ({
  className,
  ...properties
}: Readonly<ComponentProps<typeof Description>>) => {
  return (
    <Description
