/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8846e04d29bba1c0ce4f3a5d3642dd57)
// Runtime types generated with workerd@1.20260706.1 2026-07-09 nodejs_compat
interface __BaseEnv_Env {
	LOGGER_CLIENT_API_KEY: SecretsStoreSecret;
	ADMIN_USER: string;
	ADMIN_PASS: string;
	ethang_courses: Fetcher /* ethang-courses */;
	ethang_rss: Fetcher /* ethang-rss */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_USER" | "ADMIN_PASS">> {}
}
