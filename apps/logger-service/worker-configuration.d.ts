/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: feb9f38923566438411273e253a61438)
// Runtime types generated with workerd@1.20260706.1 2026-07-09 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	DB: D1Database;
	SERVER_API_KEYS: SecretsStoreSecret;
	CLIENT_API_KEYS: SecretsStoreSecret;
	ADMIN_KEY: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_KEY" | "ALLOWED_ORIGINS">> {}
}
