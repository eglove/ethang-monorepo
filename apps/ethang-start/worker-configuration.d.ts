/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --config=../ethang-courses/wrangler.jsonc --config=../ethang-rss/wrangler.jsonc` (hash: c04575cb3c5c759a8b03a4eac3e31569)
