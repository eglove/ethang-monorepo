...
import { HowIWork } from "./how-i-work.tsx";
...
describe("HowIWork", () => {
  ...
  it("renders all three principle titles", () => {
    ...
    expect(screen.getByText("Domain-Driven Design as the bridge.")).toBeDefined();
  });

  it("renders principle bodies with correct text", () => {
    render(<HowIWork />);
    const text = screen.getByTestId("how-i-work").textContent;
    expect(text).toContain("I write the failing test before the implementation");
