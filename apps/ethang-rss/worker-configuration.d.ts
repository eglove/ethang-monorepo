/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: db9be14c54638022eab55c957d922501)
// Runtime types generated with workerd@1.20260706.1 2026-07-09 nodejs_compat
interface __BaseEnv_Env {
	ethang_rss: D1Database;
	LOGGER_API_KEY: SecretsStoreSecret;
	FETCH_FEEDS_WORKFLOW: Workflow<Parameters<import("./src/index").FetchFeedsWorkflow['run']>[0]['payload']>;
}
