...
import type { coursesTable, courseTrackingTable, curriculumLearningPathsTable, curriculumsTable, learningPathCoursesTable, learningPathsTable } from "../db/schema.ts";
...
export type DatabaseTransaction = Database | Parameters<Parameters<Database["transaction"]>[0]>[0];
