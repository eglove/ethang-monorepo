  ...
  return (
    <LocalBlog slug="forcing-react">
      ...
      <TypographyP>
        ...
        have implemented signals for fine-grained reactivity. It feels like
        React is falling behind. And as a result, falling behind in performance.
      </TypographyP>
      <Image
      ...
      <TypographyP>
        ...
        <span className="font-bold">not</span> rerendering everything on every
        change should be the default behavior, as it is in every other framework
      </TypographyP>
      <TypographyP>
        ...
        . With no performance optimizations, it's only a tad faster than
        Zustand. But within the same performance category. Even{" "}
      ...
      <TypographyP>
        ...
        beta which introduces synchronization for local-first apps. Which is
        pretty appealing.
      </TypographyP>
      <TypographyP>
      ...
      <TypographyP>
        ...
        did not separate keyed and non-keyed frameworks. Because as of today,
        they are split into two categories. And in the "keyed" category Legend
        State does not outperform Zustand, Recoil, MobX or any other.
      </TypographyP>
      <TypographyP>
      ...
      <TypographyP>
        ...
        their example uses a{"<Memo/>"} component wrapper. But recreate it, and
        you realize how handy this component really is. Legend state is
        providing a standard library for React in a similar vein to Effect.ts
        providing a standard library for JavaScript.
      </TypographyP>
      <TypographyP>
