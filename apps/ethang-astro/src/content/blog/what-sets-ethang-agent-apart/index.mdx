...
<PostImage src={ExecCalls} alt="The desktop transcript with exec tool calls rendered as expandable cards" caption="Exec calls in the transcript: the program on the call card, the full result on the result card." />
