...
- **File explorer** with live syntax highlighting, driven by a file watcher rather than tool-call hooks
- A **file explorer** with live syntax highlighting driven by a file watcher, and a **git view** with realtime diffing, PR management, and CI status the explorer with live syntax highlighting driven by a file watcher, the git side with realtime diffing, PR management, and CI status
...
Credit where the field leads. Claude Code and Codex have frontier models tuned into their harnesses; Cursor and Windsurf have years of editor polish and enormous user bases; OpenCode has community scale and cross-platform reach. eThang Agent is Windows-first by choice, younger than its competitors, and its community is smaller. Those are real costs.
