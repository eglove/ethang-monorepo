---
blogCategory: "Blog"
description: "Moving personal projects to microservices on Cloudflare Workers behind an Apollo Supergraph. Discover why Drizzle, Codegen, and Apollo Client make it seamless."
featuredImage: ./images/featured.jpg
featuredImageAlt: "A stylized, high-tech isometric blueprint diagram, rendered in glowing electric blue lines on a dark, circuit-board-like grid background. Multiple geometric cubes and hexagonal platforms are connected by illuminated network paths, data streams, and smaller orbital clusters, symbolizing a complex, integrated system of microservices and an Apollo GraphQL gateway. The central, radiant core pulses with light, linking diverse nodes and code-like structures into a cohesive ecosystem."
