/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --config=../ethang-courses/wrangler.jsonc --config=../ethang-rss/wrangler.jsonc` (hash: b99c6fe5a3ca2b275d52d6aae7999dcb)
