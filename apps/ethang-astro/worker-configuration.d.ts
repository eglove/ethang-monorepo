/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc --config=../ethang-courses/wrangler.jsonc --config=../ethang-rss/wrangler.jsonc --config=../job-applications/wrangler.jsonc` (hash: 2d1a957cb8071868189078e0d95bf732)
// Runtime types generated with workerd@1.20260811.1 2026-08-14 global_fetch_strictly_public
interface __BaseEnv_Env {
 ASSETS: Fetcher;
 ethang_courses: Service<
  typeof import("../ethang-courses/dist-types/index").default
 >;
 ethang_rss: Service<typeof import("../ethang-rss/dist-types/index").default>;
 job_applications: Service<
  typeof import("../job-applications/dist-types/index").default
 >;
}
