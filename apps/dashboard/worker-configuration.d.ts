/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8d799fe27202a457778567c1804c86ee)
// Runtime types generated with workerd@1.20250617.0 2025-06-22 
declare namespace Cloudflare {
	interface Env {
		CLERK_PUBLIC_KEY: string;
		CLERK_SECRET_KEY: string;
		DB: D1Database;
		clerkPublishableKey: SecretsStoreSecret;
		clerkSecretKey: SecretsStoreSecret;
	}
}
