  ...
  return (
    ...
    >
      ...
      <Blockquote
        ...
        sourceUrl="https://github.com/cloudflare/vinext/issues/21#issuecomment-3956481929"
      >
        ...
        Cloudflare Workers org, almost 80+ people at this point. I'm not just an
        IC engineer who has to find time to justify continuing to work on this.
        I can literally put people on it, and I've already been talking to the
        team about how to do exactly that.
      </Blockquote>
      <P>
      ...
      >
        ...
        Next. I've definitely heard from people that there are things about Next
        they don't like, and I appreciate that perspective. But right now,
        diverging significantly from Next's API surface isn't really in scope.
        Obviously, we already me an exception with TPR, which is an alternative
        take on pre-rendering, but the bulk of the Next.js APIs we're trying to
        match 1:1. The reason is straightforward: we're trying to give customers
        who are having a hard time hosting Next on Cloudflare a better time.
      </Blockquote>
      <P>
      ...
      <Blockquote
        ...
        sourceUrl="https://github.com/cloudflare/vinext/issues/21#issuecomment-3956638369"
      >
        I’m flattered to see the FanStack out in full force...
      </Blockquote>
      <P>
      ...
      >
        ...
        get, and figure out where to take it from there. Hopefully that answers
      ...
      <P>
        ...
        Today we see less innovation, less systems thinking, less
        problem-solving. I look around and see people at the slot machines of AI
        turning silly weekend thoughts into pointless slop. I miss developers.
      </P>
    </BlogLayout>
  );
};
